  ...
  const features = [
    {
      ...
      description:
        'From blockchain fundamentals to advanced smart contract development on Stellar.',
      icon: <BookOpen className="h-8 w-8 icon" />,
    },
    {
      title: 'Interactive Learning',
      description:
        'Hands-on labs and real-world projects built with Soroban on the Stellar network.',
      icon: <Code className="h-8 w-8 icon" />,
    },
    {
      title: 'Vibrant Community',
      description:
        'Connect with peers, mentors, and industry experts in our growing blockchain ecosystem.',
      icon: <Users className="h-8 w-8 icon" />,
    },
    {
      title: 'Stellar Integration',
      description:
        'Built on Stellar blockchain with secure smart contracts for credentialing and token management.',
