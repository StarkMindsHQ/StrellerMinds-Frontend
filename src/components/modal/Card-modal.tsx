...
const CardModal: React.FC<CardModalProps> = ({
  ...
  return (
    <div className="w-full max-w-lg bg-white rounded-lg shadow-md">
      ...
      <p className="text-gray-600 px-6 pb-4">
      ...
      <div className="flex justify-center items-center mx-6 mb-6">
        <div className="flex w-full rounded-lg bg-gray-100 p-1">
          ...
          >
            <span
              className={
                currentMethod === 'crypto' ? 'text-gray-900' : 'text-gray-500'
              }
            >
              <FaRegStar size={20} />
            </span>
            <span
              className={`font-medium ${currentMethod === 'crypto' ? 'text-gray-900' : 'text-gray-500'}`}
            >
              Crypto
            </span>
          </button>
          ...
          >
            <span
              className={
                currentMethod === 'card' ? 'text-gray-900' : 'text-gray-500'
              }
            >
              <FiCreditCard size={20} />
            </span>
            <span
              className={`font-medium ${currentMethod === 'card' ? 'text-gray-900' : 'text-gray-500'}`}
            >
              Card
            </span>
          </button>
