          ...
          <div className="flex flex-col space-y-8 max-w-2xl">
            <div>
              ...
              <p className="mt-6 max-w-xl text-lg text-gray-600">
                Comprehensive blockchain education with high-quality video content,
                interactive labs and a vibrant community of learners and experts.
              </p>
            </div>
              ...
              <div className="flex items-center bg-gradient-to-r from-[#5c0f49]/10 to-[#7a1a5f]/10 p-4 rounded-lg border border-[#ffcc00]/20 backdrop-blur-sm shadow-lg">
                ...
                <div className="ml-4 flex flex-col">
                  <p className="text-[#5c0f49] font-mono text-sm">
                    Join <span className="text-[#ffcc00] font-bold">2,500+</span> <span className="relative">
                      learners
                      <span className="absolute bottom-0 left-0 w-full h-[1px] bg-[#ffcc00]/50"></span>
                    </span>
                  </p>
                  <p className="text-[#5c0f49]/70 text-xs">worldwide community</p>
                </div>
              </div>
            </div>
          </div>
