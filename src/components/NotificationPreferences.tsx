  ...
  return (
    <div className="flex items-center justify-between p-4 bg-white/70 rounded-xl border border-purple-100 hover:border-purple-200 transition-all duration-300">
      ...
      <label className="relative inline-flex items-center cursor-pointer">
        ...
        />
        <div
          className={`w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-[#5c0f49]/20 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-gradient-to-r peer-checked:from-[#5c0f49] peer-checked:to-purple-600 ${
        ...
        <div className="space-y-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <h4 className="text-lg font-semibold text-[#5c0f49]">
                Email Notifications
              </h4>
            </div>
            <div className="space-y-4">
              <NotificationToggle
                ...
                onChange={(checked) =>
                  updateSetting('emailNotifications', 'promotional', checked)
                }
              ...
              <NotificationToggle
                ...
                onChange={(checked) =>
                  updateSetting('emailNotifications', 'transactional', checked)
                }
              ...
              <NotificationToggle
                ...
                onChange={(checked) =>
                  updateSetting('emailNotifications', 'courseUpdates', checked)
                }
          ...
          <div>
            ...
            <div className="space-y-4">
              <NotificationToggle
                ...
                onChange={(checked) =>
                  updateSetting('inAppNotifications', 'assignments', checked)
                }
              ...
              <NotificationToggle
                ...
                onChange={(checked) =>
                  updateSetting('inAppNotifications', 'messages', checked)
                }
              ...
              <NotificationToggle
                ...
                onChange={(checked) =>
                  updateSetting('inAppNotifications', 'announcements', checked)
                }
                icon={<AlertCircle className="h-4 w-4 text-orange-500" />}
              />
              ...
              <NotificationToggle
                ...
                onChange={(checked) =>
                  updateSetting('inAppNotifications', 'reminders', checked)
                }
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <NotificationToggle
                ...
                onChange={(checked) =>
                  updateSetting('pushNotifications', 'courseDeadlines', checked)
                }
              ...
              <NotificationToggle
                ...
                onChange={(checked) =>
                  updateSetting('pushNotifications', 'newMessages', checked)
                }
                icon={<Mail className="h-4 w-4 text-blue-500" />}
                disabled={!settings.pushNotifications.enabled}
              />
              ...
              <NotificationToggle
                ...
                onChange={(checked) =>
                  updateSetting('pushNotifications', 'systemUpdates', checked)
                }
