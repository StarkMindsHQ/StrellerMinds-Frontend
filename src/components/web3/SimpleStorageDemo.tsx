  ...
  return (
    <Card className="w-full max-w-2xl mx-auto">
      <CardHeader>
        ...
        <CardDescription>
          Interact with a simple storage smart contract. Store and retrieve values on the blockchain.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        ...
        <div className="p-4 bg-muted rounded-lg">
          <div className="flex items-center justify-between">
            <div>
              <Label className="text-sm font-medium">Current Stored Value</Label>
        ...
        {/* Code Example */}
        <div className="p-4 bg-muted rounded-lg">
          <Label className="text-sm font-medium mb-2 block">Smart Contract Function</Label>
