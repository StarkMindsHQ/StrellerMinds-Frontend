      ...
      <div className="space-y-12 py-10">
        <div className="flex flex-col items-center gap-6 text-center">
          ...
          <p className="text-muted-foreground max-w-2xl">
            Test the premium file upload component below. It supports drag-and-drop, 
            multiple file selection, type/size validation, and previews.
          </p>
        </div>

        <section className="space-y-6">
          <div className="bg-card p-10 rounded-3xl border border-border shadow-sm">
            <h2 className="text-2xl font-bold mb-6 text-center">Default Multipurpose Upload</h2>
            <FileUpload 
        ...
        {selectedFiles.length > 0 && (
          <div className="p-6 bg-secondary/50 rounded-xl border border-secondary">
            <h3 className="text-sm font-bold uppercase tracking-wider mb-2">Debug Info:</h3>
