    ...
    <div className="container mx-auto py-20 px-4 min-h-screen bg-background text-foreground space-y-12">
      <div className="text-center space-y-4">
        ...
        <p className="text-muted-foreground">
          Demo of the premium blockchain balance display
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        ...
        <div className="space-y-4">
          ...
          <TokenBalance balance="4,500.00" symbol="USDT" label="My USDT" />
        </div>
      </div>
      ...
      <div className="p-8 border border-border rounded-xl bg-card max-w-4xl mx-auto">
        ...
        <ul className="list-disc pl-5 space-y-2 text-sm text-muted-foreground">
          <li>
            <strong>Glassmorphism:</strong> Uses backdrop-blur and
            semi-transparent borders.
          </li>
          <li>
            <strong>Real-time:</strong> Tooltip shows relative "Last Sync" time
            (e.g., "Just now", "2m ago").
          </li>
          <li>
            <strong>Animation:</strong> The refresh icon rotates during the
            loading phase.
          </li>
          <li>
            <strong>Accessibility:</strong> Tooltip provides additional context
