    ...
    <MainLayout variant="full-width" padding="none" background="transparent">
      ...
      <section className="bg-white text-gray-900 px-4 py-12">
        ...
        <div className="text-center max-w-2xl mx-auto mb-10">
          <div className="rounded-xl bg-[#FFF8E7] text-[#6B4226] mb-10 w-1/4 mx-auto font-ubuntu py-2">
            Contact
          </div>
          ...
          <p className="text-gray-600 text-base px-2 font-EB-Garamond">
            ...
            courses. We take pride in providing solutions and look forward to
            hearing from you.
          </p>
          <div className="my-6">
        ...
        <div className="flex justify-center">
          <div className="w-full max-w-3xl bg-white p-8 rounded-xl shadow-lg">
            <h3 className="text-xl font-semibold text-center text-amber-900 mb-6">
              Send us a message
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <p className="md:col-span-2 text-sm text-gray-500">
                Your details will be safe and your personal data is stored as
                described in our{' '}
          ...
          <div className="flex gap-4 items-center">
            ...
            <div>
              ...
              <p className="text-sm text-gray-700 mt-2 text-left">
                1, Education Close, 2 & 3 Sewer Estate,
                <br />
