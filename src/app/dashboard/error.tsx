...
export default function DashboardError({ error, reset }: ErrorProps) {
  useEffect(() => {
    // Log the dashboard-specific error
      ...
      <div className="max-w-lg w-full text-center space-y-6">
        ...
        <div className="flex justify-center">
          <div className="relative">
            <div className="bg-[#dfb1cc]/20 dark:bg-[#dfb1cc]/10 rounded-full p-4">
              <LayoutDashboard className="h-16 w-16 text-[#5c0f49] dark:text-[#dfb1cc]" />
            </div>
            <AlertTriangle className="absolute -top-1 -right-1 h-8 w-8 text-red-500 bg-white dark:bg-gray-900 rounded-full p-1" />
          </div>
        </div>
        ...
        <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3">
          <p className="text-sm text-blue-700 dark:text-blue-300">
            💡 <strong>Tip:</strong> This error is isolated to the dashboard.
            Other parts of the application should work normally.
          </p>
        </div>
