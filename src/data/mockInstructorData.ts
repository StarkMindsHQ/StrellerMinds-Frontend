...
export const MOCK_STUDENTS: MockStudent[] = [
  ...
  },
  {
    ...
    course: 'Smart Contracts & Solidity',
    progress: 75,
    status: 'active',
...
export const MOCK_APPLICATIONS: MockApplication[] = [
  {
    ...
    status: 'pending',
    message: 'Interested in the upcoming cohort.',
  },
  {
    id: 'a2',
    applicantName: 'Jamie Martinez',
    email: 'jamie.m@example.com',
    course: 'Smart Contracts & Solidity',
  ...
  {
    id: 'a3',
    applicantName: 'Reese Anderson',
    email: 'reese.a@example.com',
    course: 'Introduction to Blockchain',
    submittedAt: '2025-02-18',
    status: 'rejected',
    message: 'Does not meet prerequisites.',
  },
  {
    id: 'a4',
    applicantName: 'Avery Clark',
    email: 'avery.c@example.com',
    course: 'DeFi Fundamentals',
