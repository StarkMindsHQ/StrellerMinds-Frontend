  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-1">
        <h3 className="font-semibold text-lg text-red-600 dark:text-red-400">{title}</h3>
        <p className="text-sm text-red-500 dark:text-red-400/80">{errorMessage}</p>
      </div>
      <Button variant="destructive" onClick={handleRetryClick} disabled={isRetrying} className="mt-2">
